...
export default function Signup() {
  ...
  const handleGoogleAuth = async () => {
    let googleEmail = prompt('Enter your Google Account email to sign up with Google:', 'newuser.google@gmail.com');
    ...
    try {
      ...
      if (data.access && data.refresh) {
        localStorage.setItem('movesmart_access', data.access);
        localStorage.setItem('movesmart_refresh', data.refresh);
      }
